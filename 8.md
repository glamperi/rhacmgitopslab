...
sed -io 's/replicas: [0-9]/replicas: 0/g' overlays/cluster1/pacman-deployment.yaml
...
sed -io 's/replicas: [0-9]/replicas: 0/g' overlays/cluster2/pacman-deployment.yaml
# Stage your changes to be sent to the git repository
...
~~~sh
# Modify the replica count in cluster1
sed -io 's/replicas: [0-9]/replicas: 1/g' overlays/cluster1/pacman-deployment.yaml
# Modify the replica count in cluster2
sed -io 's/replicas: [0-9]/replicas: 1/g' overlays/cluster2/pacman-deployment.yaml
# Stage your changes to be sent to the git repository
